$(document).ready(function(){
    ...
    /*****************************************************************/
    /***** Sidebar Fixed - Utilizado apenas no Guia de Elementos *****/
    /*****************************************************************/
    var offset = $("#guide-move").offset();
    var topPadding = 120;
    $(window).scroll(function() {
        if ($(window).scrollTop() > offset.top) {
            $("#guide-move").stop().animate({
...
function checkFooter() {
    var alturaPagina = ($("body > header").height() + $("div#content").height() + $("body > footer").height() * 2);
